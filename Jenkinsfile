    ...
    stages {
        ...
        stage('Deploy code to App server'){
            steps {
                ...
                sh 'scp -i /tmp/jenkinskey.pem -o StrictHostKeyChecking=no codebase/target/SampleServlet.war ec2-user@ec2-34-242-162-22.eu-west-1.compute.amazonaws.com:/tmp/tomcat/apache-tomcat-8.5.47/webapps'
                echo 'code Deployed'
            }
        }
